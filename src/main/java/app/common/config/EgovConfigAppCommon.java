...
import app.common.config.etc.EgovComTraceHandler;
import app.common.config.etc.EgovMessageSource;
import app.common.config.etc.EgovMultipartResolver;
import app.common.config.etc.ImagePaginationRenderer;
 ...
 */
@Configuration
@ComponentScan(basePackages = "app", includeFilters = {
